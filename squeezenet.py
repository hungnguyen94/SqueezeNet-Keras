...
from keras.layers import Input, Convolution2D, MaxPooling2D, Dropout, GlobalAveragePooling2D, merge, Activation
...
def FireModule(s_1x1, e_1x1, e_3x3, name):
    ...
    def layer(x):
        ...
        expand_1x1 = Convolution2D(e_1x1, 1, 1, border_mode='same', activation='relu', name=name+'_expand_1x1')(squeeze)
        expand_3x3 = Convolution2D(e_3x3, 3, 3, border_mode='same', activation='relu', name=name+'_expand_3x3')(squeeze)
